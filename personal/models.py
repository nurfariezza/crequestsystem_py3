...
class comment(models.Model):
    ...
    def __str__(self):
        return  u'{0} - {1} - {2}'.format(self.appsid, self.email, self.comment)
...
class logact(models.Model):
    ...
    def __str__(self):
        return  u'{0} - {1} - {2} {3}'.format(self.log_req_id, self.log_time, self.log_action,self.name )  
...
class ReqForm(models.Model):
    ...
    completeddate = models.DateTimeField(auto_now_add=False)
    ...
    def reqstatusstr(self):
        ...
        elif self.reqstatus == 10:
            return 'Verified done'

        elif self.reqstatus == 11:
            return 'Modify draft to request.'

        elif self.reqstatus == 12:
            return'Reminder to perform verification has been sent!'
...
class Assign(models.Model):
    ...
    def __str__(self):
        return u'{0} - {1} '.format(self.req_id, self.assignto)
